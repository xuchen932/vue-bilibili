            ...
            <div class="l-con">
                <div class="zone-title">
                    <div class="headline clearfix">
                        <i class="icon-shishang"></i>
                        <a href="#" class="name">时尚</a>
                        <div class="bili_tab">
...
export default {
    ...
    created: function () {
        // GET /someUrl
        this.$http.get('https://www.easy-mock.com/mock/5c7d1b71cf384074c61ce181/bilibili/biliwrapper1').then(response => {
...
<style>
    .donghua .zone-module .l-con .headline .icon-shishang{
        width: 40px;
        height: 40px;
        margin-right: 10px;
